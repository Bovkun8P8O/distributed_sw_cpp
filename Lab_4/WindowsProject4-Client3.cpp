// WindowsProject4-Client3.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "WindowsProject4-Client3.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WINDOWSPROJECT4CLIENT3, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINDOWSPROJECT4CLIENT3));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WINDOWSPROJECT4CLIENT3));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WINDOWSPROJECT4CLIENT3);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, L"Client 3", WS_OVERLAPPEDWINDOW,
      590, 550, 420, 260, nullptr, nullptr, hInstance, nullptr);
...
BOOL SetConnection(HWND hWnd)
{
    ...
    // при спробі з'єднання головне вікно отримає повідомлення WSA_ACCEPT0
...
void SendMsg(HWND hWnd) // повідомлення від клієнта 3
{
    RECT rect;
    GetWindowRect(hWnd, &rect);
    
    char lorem[] = "Lorem ipso dolor sit amet, consectetur adipiscing elit.";
    int randCount = rand() % (_countof(lorem) - 1) + 1;

    char randLorem[_countof(lorem) + 1];
    strncpy_s(randLorem, lorem, randCount);

    sprintf_s(szBuf, "Random text: %s \r\n", randLorem);
