// WindowsProject5-Client2.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "WindowsProject5-Client2.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WINDOWSPROJECT5CLIENT2, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINDOWSPROJECT5CLIENT2));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WINDOWSPROJECT5CLIENT2));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WINDOWSPROJECT5CLIENT2);
    ...
    case WM_PAINT:
        {
            ...
            sprintf_s(mess, "Client 2:\r\n3DBorder width: %d\r\n3DBorder height: %d\r\nColors number: %d\r\n",
				GetSystemMetrics(SM_CXEDGE),        // ширина 3Д-рамки вікна, а не панелі інструментів
				GetSystemMetrics(SM_CYEDGE),        // висота 3Д-рамки вікна, а не рядка статусу
				GetDeviceCaps(hdc, NUMCOLORS));     // кількість кольорів пристрою відображення
            /*NUMCOLORS:
