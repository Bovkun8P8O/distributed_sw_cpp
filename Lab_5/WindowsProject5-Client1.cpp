// WindowsProject5-Client1.cpp : Defines the entry point for the application.
//

#include "framework.h"
#include "WindowsProject5-Client1.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WINDOWSPROJECT5CLIENT1, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINDOWSPROJECT5CLIENT1));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WINDOWSPROJECT5CLIENT1));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WINDOWSPROJECT5CLIENT1);
    ...
    case WM_PAINT:
        {
            ...
            sprintf_s(mess, "Client 1:\r\nCursor width: %d\r\nSystem time: %02d:%02d\r\nScreen width: %d\r\n",
                GetSystemMetrics(SM_CXCURSOR),  // SM_NETDRIVE не існує, тому тут випадкова метрика 
                st.wHour, st.wMinute,           // системний час
				GetDeviceCaps(hdc, HORZRES));   // ширина екрану в пікселях
            SendMessageA(hwndEdit, WM_SETTEXT, 0, (LPARAM)m_mess);
